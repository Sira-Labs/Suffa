...
| ------------------------ | ------------------------ | ---------------------------- |
| Units                    | 4 (own drafts, 1–4)      | 16                           |
| Vocabulary               | 128 words                | ≈ 800–1,000 words            |
| Dialogues                | 9 (own, 2–3 per unit)    | ≈ 3 per unit (≈ 48)          |
| Verbs with full tables   | 4                        | ≈ 60–80                      |
...
Status 2026-09-24: units 1–4 are **own drafts** on the book's unit topics (greetings and
nationality, family, housing, daily routine), marked `"status": "entwurf"` until the teacher
...
an empty root (no root cards). Verb tables of sound form-I verbs are generated by pattern.
