...
import { createSummaryRoutes, type SummaryRouteDeps } from './media/summaryRoutes.js';
...
export interface AppDeps {
  ...
  /** Lesson summaries of recordings (EU model, published by the teacher). */
  summaries?: SummaryRouteDeps;
