...
| Grammar & alphabet | One grammar point per dialogue section (48, with questions); an alphabet course in eight lessons for absolute beginners.                                                                                                                                                                                                |
...
| **P1 Identity, roles & classes** | S3–S4   | Nov 2 – Nov 29  | ☐        | Better Auth, RBAC, `ApiSyncProvider`, Supabase removed, admin v1, **classes + invite links**.                                                                                                                                                                                                     | `v1.2` — Supabase off |
