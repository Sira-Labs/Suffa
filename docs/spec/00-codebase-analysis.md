...
| G10 | **HashRouter.** Fine for static hosting, but deep links/SEO for a public landing page are poor.                                                                         | Minor.                                                                      | Move to `createBrowserRouter` once served by our own Nginx (Sprint 2)        |
