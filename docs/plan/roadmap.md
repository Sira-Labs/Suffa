...
| -------------------------------- | ------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| **P0 Foundation**                | S1–S2   | Oct 5 – Nov 1   | Monorepo, CI, Tabayyun-style CapRover deploy (`docs/ops/caprover-deployment.md`), API + worker skeleton, Postgres queue, backups. | `v1.1`                |
...
1. **G0 (end S2):** one-command deploy to CapRover; restore drill passed.
